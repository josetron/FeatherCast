...
const f1 = fs.readFileSync('archive/versions/2026-05-26_06-38-16/index.html', 'utf8').split('\n');
const f2 = fs.readFileSync('index.html', 'utf8').split('\n');
